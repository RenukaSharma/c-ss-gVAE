...
res_dir="/home/renuka/AD/results_bayesian_Malaria-patchwise/BS-128/no-noise_with0.1pollution_inv-loss-noveltest_May22/baseline-ssad-hybrid-withVarLearning"
mkdir ${res_dir}
for i in {0..4}
do
...
res_dir="/home/renuka/AD/results_bayesian_Malaria-patchwise/BS-128/GG-noise_with0.2pollution_inv-loss-noveltest_May22_20kand5k/baseline-ssad"
mkdir ${res_dir}
for i in {0..4}
do
    for n_known_outlier_classes in 1
