...
res_dir="/home/renuka/AD/results_bayesian_Malaria-patchwise/BS-128/with-SPnoise-no-pollution-inv-loss-noveltest_take-2/baseline-ssad-hybrid-withVarLearning"
mkdir ${res_dir}
for i in {0..4}
do
...
res_dir="/home/renuka/AD/results_bayesian_Malaria-patchwise/BS-128/with-SPnoise-no-pollution-inv-loss-noveltest_take-2/baseline-ssad"
mkdir ${res_dir}
for i in {0..4}
do
    for n_known_outlier_classes in 1
